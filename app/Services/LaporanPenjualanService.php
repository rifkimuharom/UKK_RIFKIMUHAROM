...
class LaporanPenjualanService
{
    ...
    {
        return $this->ringkasanPeriode(Carbon::today()->startOfDay(), Carbon::today()->endOfDay());
    }

    public function ringkasanPeriode(Carbon $start, Carbon $end): array
    {
    ...
    {
        return $this->produkTerlarisPeriode(Carbon::today()->startOfDay(), Carbon::today()->endOfDay(), $limit);
    }

    public function produkTerlarisPeriode(Carbon $start, Carbon $end, int $limit = 5)
    {
